...
set_target_properties(OQS::oqs PROPERTIES
  IMPORTED_LOCATION_NOCONFIG "${_IMPORT_PREFIX}/lib/liboqs.so.0.15.0-rc1"
  IMPORTED_SONAME_NOCONFIG "liboqs.so.9"
  )

list(APPEND _cmake_import_check_targets OQS::oqs )
list(APPEND _cmake_import_check_files_for_OQS::oqs "${_IMPORT_PREFIX}/lib/liboqs.so.0.15.0-rc1" )
